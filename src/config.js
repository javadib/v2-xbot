...
به ربات ${config.bot.name} خوش آمدید! 🎉 از اینکه در اینجا هستید، بسیار خوشحالیم.

ما در اینجا هستیم تا به شما کمک کنیم و هر سوال یا درخواستی که دارید را رفع کنیم.
